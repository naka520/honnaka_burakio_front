...
const Setting: React.FC = () => {
  ...
  const [topUpBalance, setTopUpBalance] =
    useState<TopUpBalance>(initialTopUpbalance);
  ...
  const balanceEndpointUrl = `https://brachiocup-honnaka-backend.azurewebsites.net/api/v1/me/groups/${groupUuid}/top_up_balance`;
  ...
  useEffect(() => {
    ...
    const meEndPointUrl = `https://brachiocup-honnaka-backend.azurewebsites.net/api/v1/me`;
    axios
  ...
  const withDrawalEndpointUrl = `https://brachiocup-honnaka-backend.azurewebsites.net/api/v1/me`;
